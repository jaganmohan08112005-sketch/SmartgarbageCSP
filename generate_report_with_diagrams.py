...
_body("Rapid urbanization and population growth in semi-urban regions such as Chintalavalasa, Andhra Pradesh, have intensified waste management challenges. Existing systems rely heavily on manual collection schedules, paper-based complaint tracking, and limited citizen participation, leading to overflowing bins, delayed complaint resolution, and environmental degradation.")
