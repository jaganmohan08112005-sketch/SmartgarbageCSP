...
# process and the RQ worker from one service. eventlet yields on SSE/SocketIO
...
web: gunicorn wsgi:app --bind 0.0.0.0:$PORT -w 1 --worker-class eventlet --timeout 120 --keep-alive 5
