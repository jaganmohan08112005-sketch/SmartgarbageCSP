...
pdf.body_text('Rapid urbanization and population growth in semi-urban regions such as Chintalavalasa, Andhra Pradesh, have intensified waste management challenges. Existing systems rely heavily on manual collection schedules, paper-based complaint tracking, and limited citizen participation, leading to overflowing bins, delayed complaint resolution, and environmental degradation.')
pdf.body_text('This project presents SmartGarbage Chintalavalasa, a community-based smart waste management and digital governance system designed for the Chintalavalasa Gram Panchayat. The system integrates multiple technologies \u2014 a Flask-based web application, PostgreSQL database, IoT smart-bin telemetry, machine learning predictions using a RandomForest regressor, Progressive Web App offline capabilities, and a pay-as-you-throw billing mechanism \u2014 into a single, unified platform accessible to citizens, administrators, and sanitation workers.')
